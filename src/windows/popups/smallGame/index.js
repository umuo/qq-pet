    ...
    data: () => ({
      ...
      gameList: [{
        ...
        children: [{
          ...
          name: "5黑暗之眼",
          router: "mxd/5黑暗之眼.swf"
        }, {
          name: "6巨树",
          router: "mxd/6巨树.swf"
        }, {
          name: "7巨树之颠",
          router: "mxd/7巨树之颠.swf"
        }, {
          name: "8宝藏",
          router: "mxd/8宝藏.swf"
        }]
        ...
        children: [{
          name: "灰太狼",
          router: "hpxyx/灰太狼.swf"
        }, {
          name: "QQ钓鱼",
          router: "hpxyx/QQ钓鱼.swf"
        }, {
          name: "满天星",
          router: "hpxyx/满天星.swf"
        }, {
          name: "三明治",
          router: "hpxyx/三明治.swf"
        }, {
          name: "抓萤火虫",
          router: "hpxyx/抓萤火虫.swf"
        }]
      }],
      current: "",
