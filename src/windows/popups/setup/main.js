                          ...
                          if ((console.log("logs", "res"), e?.logs)) {
                            ...
                            for (let a in e.sponsorList)
                              t.values.push(
                                e.sponsorList[a].name +
                                  " QQ：" +
                                  hideAccountName(e.sponsorList[a].account) +
                                  "； ",
                              );
                            let o = {
                              label: "赞助资源",
                            ...
                            for (let t in e.sourceList) {
                              ...
                              o.values.push(
                                e.sourceList[t].name +
                                  " QQ：" +
                                  hideAccountName(e.sourceList[t].account) +
                                  " 资源：" +
                                  a +
                                  "； ",
                              );
            ...
            setup_h_setStting_m: (e, t) => {
              ...
              if ("radio" == t.data?.type) {
                ...
                if ("startupSelf" == t.data.value) {
                  let e = { data: { type: "text" }, nextActiveStr: "speak" };
                  (t.data?.data
              ...
              if ("buts" == t.data?.type) {
                if (h) return;
                if (((h = !0), "newScreen" == t.data.value)) getScreenSize(!0);
                  ...
                  let e =
                    "GG" == $Store.getItem("pet")?.info?.sex ? "MM" : "GG";
                  ($Store.clear(),
                  ...
                  "newProgram" == t.data.value
                    ...
                    : "urlWindow" == t.data.value
                      ...
                      : "urlWindowOpen" == t.data.value
                        ...
                        : "viewSwf" == t.data.value || "viewSwf" == t.data.value
