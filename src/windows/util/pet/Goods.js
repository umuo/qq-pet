...
class Goods {
  storeGoods = { food: [], commodity: [], medicine: [], background: [] };
  backUseConsumables = () => {};
  callUseActive = () => {};
  constructor(e = {}) {
    (this.getConsumables(),
      e.backUseConsumables && (this.backUseConsumables = e.backUseConsumables),
    ...
    let { goodNames: t, goodName: s } = e,
      ...
      a = (e) => {
        ...
        return (
          s[1] &&
            ((l.num = s[1]),
            (l.valueList.num = { label: "数量：", value: s[1] + "个" })),
          o.starve &&
            (l.valueList.starve = { label: "饥饿值 ", value: "+" + o.starve }),
          o.clean &&
            (l.valueList.clean = { label: "清洁值 ", value: "+" + o.clean }),
          (o.charm || o.intel || o.strong) &&
            (l.valueList.opt = {
              label: "属性：",
              value: `${o.charm ? ` 魅力 +${o.charm} ` : ""}${o.intel ? ` 智力 +${o.intel} ` : ""}${o.strong ? ` 武力 +${o.strong} ` : ""}`,
            }),
          o.desc && (l.valueList.desc = { label: "tip：", value: o.desc }),
          l
        );
      };
    if (s) o = a(s);
  ...
  getGiftData(e, t) {
    ...
    if (
      ...
      (0 != o.length && 0 != a.length) ||
        ((o = this.getOurGoods()), (a = getRandomArr(0, o.length - 1, t)));
      for (let s in a) {
        let l = { type_Key: o[a[s]], isTake: 0 };
        ("sign" == e
          ? ((l.seeTime = tool.getTime({ format: "YY-MM-DD", addDay: s })),
      ...
      a = (e) => {
        ...
        if (o.education)
          for (let e in o.education)
            o.education[e] && a.push(getStudyLevel(e, o.education[e], !0));
        a = a.join(",");
        let l = {
          ...o,
          key: s,
          ...
          valueList: {
            ...
            workTime: { label: "工作时长：", value: o.useTime + "分钟" },
          },
        };
        return (
          (o.starve || o.clean) &&
        ...
        let s = t[1].split("_")[1],
          ...
          l = {
            ...
            valueList: {
              ...
              workTime: { label: "学习时长：", value: o.classTime + "分钟" },
  ...
  buy(goodKey) {
    try {
      ...
      if (parts.length !== 2) return { ok: !1, msg: "商品 ID 格式错误" };
