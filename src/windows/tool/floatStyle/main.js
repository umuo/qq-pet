...
class mainClass {
  constructor(t) {
    ((this.window = null), (this.show = !1), (this.name = "floatStyle"));
  }
  ...
  cleate(t) {
    ...
    windowsMain
      .open({
        ...
        created(t) {
          ...
          const i = (t, e) => {
            ...
            ((l = Math.trunc(10 * l) / 10),
              l < c[t].min ? (l = c[t].min) : l > c[t].max && (l = c[t].max));
            let s = {};
          ...
          (r.setIgnoreMouseEvents(!0, { forward: !0 }),
            u({
              ...
              "floatStyle_bus-Main_eventMouse": (t, o) => {
                o.canDoType
                  ? ((e = !1), r.setIgnoreMouseEvents(!1, { forward: !0 }))
                  : ((e = !0), r.setIgnoreMouseEvents(!0, { forward: !0 }));
              },
              ...
              floatStyle_h_openKJ_m: (t, e) => {
                e.open && o.nowShotycutsMain.loopShortcut("controlTool");
              },
            }));
        },
        onload() {
        ...
        onshow(t) {
          (console.log("onshow ", this.name), (o.window = t), (o.show = !0));
        },
        onhide() {
