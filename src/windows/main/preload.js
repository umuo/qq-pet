...
let main_html = {
  ...
  main_ToHtml_setPotision: e => ipcRenderer.on("main_bus-html_setPotision", e),
...
let html_main = {
  ...
  html_ToMain_openMenu: e => ipcRenderer.send("html_bus-main_openMenu", e),
  html_ToMain_close: e => ipcRenderer.send("html_bus-main_close", e),
  html_ToMain_backPetLoadFinish: e => ipcRenderer.send("html_bus-main_backPetLoadFinish", e),
  html_ToMain_mouse: e => ipcRenderer.send("html_bus-main_mouse", e),
  html_ToMain_getFocus: e => ipcRenderer.send("html_bus-main_getFocus", e),
