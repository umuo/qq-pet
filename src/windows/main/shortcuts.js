...
class Shotycuts {
  ...
  AddLoop(t, e, r) {
    return ((this.loopFn[t.name] = t.fns), this.upShotycut(t.name, e, r), this);
  }
  deleteLoop(t, e) {
    ((this.loopFn[t] = null), delete this.loopFn[t], this.unShotycut(e));
  }
  loopShortcut = (t, e) => {
    ...
    for (let t in r.manyFn) {
      ...
      for (let t in e.code)
        globalShortcut.isRegistered(e.code[t], e.fn)
          ...
          : r.unSet || (globalShortcut.register(e.code[t], e.fn), (s = !0));
    }
    return (
  ...
  doKeys(t) {
    let e = "";
    for (let r in t) (0 != r && (e += "+"), (e += this.keysMap[t[r]] || t[r]));
    return ((e = [e]), e);
  }
  methods = {
    screenshot: () => {
    ...
    god: () => {
      ...
      ((t = this.loopShortcut("mainShortcutKeys")
        ...
        : "上帝模式已关闭"),
        openSpeak({ data: { type: "text", data: t }, nextActiveStr: "speak" }));
    },
    openStting: () => {
      let t = setup;
