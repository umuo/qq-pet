      ...
      windowsMain
        .open({
          ...
          created(e) {
            ...
            let c = { food: "eat", commodity: "clean", medicine: "cure" };
            ((global.changeTraysIcon = (e) => {
              let { name: t = null, time: o = null, change: a = !1 } = e;
              n.menu?.activeTraysIcon
                ? n.menu?.activeTraysIcon({ name: t, time: o, change: a })
              ...
              petControl.init({
                ...
                fn: {
                  ...
                  backActive: (e = {}) => {
                    if (
                      (setSay("backActive :>> ", e), e.msg || e.communication)
                    ) {
              ...
              (global.doMovePosition = (e) => {
                if (e?.toPosition)
                  ((e.maxSize = n.maxSize), (n.nowPosition = e?.toPosition));
                else {
                  n.nowPosition = [
                ...
                (e.notChangeSize ||
                  ((n.maxSize = e.maxSize),
                  (o = { ...o, height: e.maxSize[1], width: e.maxSize[0] })),
                  t.setBounds(o),
                  (i = n.nowPosition),
                  (a = getScreenSize()),
                  tip.show &&
                    tip.setPosition({ position: i, maxSize: n.maxSize }),
                  n.isStop() ||
                    (control?.isCleate
                      ? control.setPosition({
                          position: i,
                      ...
                      : control.cleate(
                          { position: i, screenData: a, maxSize: n.maxSize },
                          t,
                        ),
            ...
            (doMovePosition({ next: r, maxSize: n.maxSize }),
              app.on("before-quit", (e) => {
                ...
                if (!n.wellClose) {
                  ((n.wellClose = !0),
                    ...
                    shotycutsMain?.cleanOur && shotycutsMain.cleanOur(),
                    n.menu?.activeTraysIcon &&
                      n.menu?.activeTraysIcon({ name: "leave", change: !0 }),
                  ...
                  openSpeak({
                    data: { type: "text", load: "exit", finish: "exit" },
              ...
              a({
                  ...
                  if ("mounted" == o.event) {
                    ...
                    (t.webContents.send("main_bus-html", {
                      ...
                      (global._buildLLMCtx = (kind) => {
                        ...
                        if (kind === "enter") {
                          ...
                          return { timeStr: `${period}${h}点`, intervalStr };
                        }
                        if (kind === "levUp") {
                    ...
                    ((global.openSpeak = (e) => {
                      ...
                      if (!getSys("doNotDisturb") || o?.mustSpeak) {
                        if (
                          ("text" == o.type || "seeTextImgs" == o.type) &&
                          "object" == typeof s &&
                          s?.length > 0
                        ) {
                          let _rec = null;
                              ...
                              .then((r) => {
                                ...
                                openSpeak({
                                  ...
                                  data: {
                                    ...
                                    submitText:
                                      _final?.submitText || o.submitText || "",
                                  },
                                });
                              });
                            return;
                      ...
                      saveSpeakData &&
                        (openSpeak(saveSpeakData), (saveSpeakData = null)),
                      t.on("blur", (e) => {
                ...
                "html_bus-main_backPetLoadFinish": (e, t) => {
                  ...
                  "finish" != t.event || ("exit" != o && "exit" != o?.finish)
                    ? (getSys("doNotDisturb") && !o?.mustSpeak) ||
                      ("speak" == t.type &&
                        o &&
                        n.openSpeak({ data: o, otherOpt: t?.otherOpt || null }))
                    : app.quit();
                },
                main_h_setPetState_m: (e, t) => {
                  ...
                  if (
                    ...
                    if (
                      ...
                      return llmService
                        .generateOnce(_tn, _buildLLMCtx(_tn), getPetInfo())
                        .then((r) =>
                          _emit(r?.tolk ? r : getCommunication(_tn || "")),
                        );
                    }
                      ...
                      e?.changeInfo &&
                        ...
                        e?.changeInfo?.addmood &&
                          t.webContents.send("main_m_setFloat_h", {
                            type: "seeFloat",
                            data: { num: e.changeInfo.addmood, time: 800 },
                          })));
                  },
                },
                {
                ...
                : "Ctrl+Shift+4" === e
                  ...
                  : "Ctrl+Shift+2" === e
                    ...
                    : "Ctrl+Shift+1" === e
                      ? o("growth", -5e3)
                      : "Ctrl+Shift+numdiv" === e
                        ? (global.addGoods && global.addGoods("commodity"), !0)
                        : "Ctrl+Shift+nummult" === e
                          ? (global.addGoods && global.addGoods("food"), !0)
                          : "Ctrl+Shift+numsub" === e
                            ? (global.addGoods && global.addGoods("medicine"),
                              !0)
                            : "Ctrl+Shift+numadd" === e
